...
public class BEKCurveTabbar: UITabBar {
    ...
    /**
     ...
     - Default is Blue
     */
    @IBInspectable public var selectedColor: UIColor = .orange  {
        didSet {
            layoutIfNeeded()
        }
    }
    ...
    /**
     ...
     - Default is Blue
     */
    @IBInspectable public var textColor: UIColor = .orange  {
        didSet {
            layoutIfNeeded()
        }
    }
    ...
    /**
     ...
     - Default is Blue.
     */
    @IBInspectable public var selectedTextColor: UIColor = .orange  {
        didSet {
            layoutIfNeeded()
        }
    }
