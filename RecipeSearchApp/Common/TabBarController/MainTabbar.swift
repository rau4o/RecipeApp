...
class MainTabbar: UITabBarController {
    ...
    func layoutUI() {
        ...
        menuController.tabBarItem = UITabBarItem(title: "menu", image: UIImage(named: "homePressed"), selectedImage: UIImage(named: "homePressed"))
        favController.tabBarItem = UITabBarItem(title: "fav", image: UIImage(named: "like"), selectedImage: UIImage(named: "like"))
        searchController.tabBarItem = UITabBarItem(title: "nil", image: UIImage(named: "search"), selectedImage: UIImage(named: "search"))
        
        viewControllers = [menuController,searchController,favController]
    }
